...
[Dask-CUDA](https://docs.nvidia.com/dask-cuda/latest/) is a library extending `LocalCluster` from `dask.distributed` to enable multi-GPU workloads.
...
Before running these instructions, ensure you have installed the [`dask`](https://docs.dask.org/en/stable/install.html) and [`dask-cuda`](https://docs.nvidia.com/dask-cuda/latest/install/) packages in your local environment.
